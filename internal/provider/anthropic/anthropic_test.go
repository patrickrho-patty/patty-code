...
// must not disappear from patty metrics and billing estimates.
...
`)
	...
	if gotUserAgent != "Patty Code" {
		t.Fatalf("User-Agent = %q, want Patty Code", gotUserAgent)
	}
