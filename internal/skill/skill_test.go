...
// writeScript creates a file at baserel with the given content.
...
func TestDisableDiscoveryReturnsEmptyStore(t *testing.T) {
	...
	project := t.TempDir()
	custom := t.TempDir()
	writeSkill(t, home, ".patty/skills/global.md", "---\ndescription: global\n---\nbody")
	writeSkill(t, project, ".patty/skills/project.md", "---\ndescription: project\n---\nbody")
...
func TestListPrecedenceProjectOverGlobal(t *testing.T) {
	home := t.TempDir()
	proj := t.TempDir()
	writeSkill(t, proj, ".patty/skills/greet.md", "---\nname: greet\ndescription: project greet\n---\nproject body")
	writeSkill(t, home, ".patty/skills/greet.md", "---\ndescription: global greet\n---\nglobal body")
	writeSkill(t, home, ".patty/skills/onlyglobal.md", "---\ndescription: only global\n---\nbody")
...
func TestPluginSkillShortAliasIsHiddenAndProjectSkillKeepsShortName(t *testing.T) {
	...
	writeSkill(t, project, ".patty/skills/plan/SKILL.md", "---\ndescription: project plan\n---\nPROJECT")
...
func TestListDecodesGB18030SkillFile(t *testing.T) {
	...
	skills := st.List()
	if len(skills) != 1 || skills[0].Description != "한글 스킬 설명" || !strings.Contains(skills[0].Body, "한글 작업 처리") {
...
func TestFlatAndDirLayout(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/flat.md", "---\ndescription: flat\n---\nflat body")
	writeSkill(t, home, ".patty/skills/dir/SKILL.md", "---\ndescription: dir\n---\ndir body")
...
func TestNestedSkillsDiscoveredByDefault(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/superpower/skill-a.md", "---\ndescription: nested flat\n---\nflat body")
	writeSkill(t, home, ".patty/skills/superpower/tool-a/SKILL.md", "---\ndescription: nested dir\n---\ndir body")
	writeSkill(t, home, ".patty/skills/superpower/references/notes.md", "---\ndescription: not a skill\n---\nnotes")
...
func TestNestedSkillsRequireDescription(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/root.md", "---\n---\nroot body")
	writeSkill(t, home, ".patty/skills/superpower/draft.md", "---\n---\ndraft body")
	writeSkill(t, home, ".patty/skills/superpower/tool/SKILL.md", "---\n---\ntool body")
...
func TestNestedDirectorySkillStopsTraversal(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/pack/SKILL.md", "---\ndescription: pack\n---\npack body")
	writeSkill(t, home, ".patty/skills/pack/child.md", "---\ndescription: child\n---\nchild body")
...
func TestPattyHomeDirOverridesGlobalPattyCodeSkills(t *testing.T) {
	home := t.TempDir()
	pattyHome := filepath.Join(t.TempDir(), "rx-home")
	writeSkill(t, home, ".patty/skills/old.md", "---\ndescription: old\n---\nold")
	writeSkill(t, home, ".patty/skills/current.md", "---\ndescription: old current\n---\nold current")
	currentPath := writeSkill(t, pattyHome, "skills/current.md", "---\ndescription: current\n---\ncurrent")

	st := New(Options{HomeDir: home, PattyHomeDir: pattyHome, DisableBuiltins: true})
	list := st.List()
	current, ok := find(list, "current")
	if !ok {
		t.Fatal("patty home skill should be discovered")
	}
	if current.Path != currentPath {
		t.Fatalf("current skill path = %q, want patty home path %q", current.Path, currentPath)
	}
	if _, ok := find(list, "old"); !ok {
		t.Fatal("legacy ~/.patty skill should remain discoverable")
	}
	...
	want := filepath.Join(pattyHome, SkillsDirname, "created", SkillFile)
	if path != want {
...
func TestExcludedPathsHideConventionRoots(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/keep.md", "---\ndescription: keep\n---\nb")
...
func TestFrontmatterFields(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/sub.md",
		"---\ndescription: a sub\nrunAs: subagent\nallowed-tools: read_file, grep\nmodel: deepseek-pro\nread-only: true\n---\nbody")
	writeSkill(t, home, ".patty/skills/fork.md", "---\ndescription: f\ncontext: fork\n---\nbody")
	writeSkill(t, home, ".patty/skills/plain.md", "---\ndescription: p\n---\nbody")
...
func TestReferencesInlined(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/withrefs/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeSkill(t, home, ".patty/skills/withrefs/references/b.md", "second ref")
	writeSkill(t, home, ".patty/skills/withrefs/references/a.md", "first ref")
...
func TestScriptsAppended(t *testing.T) {
	...
	writeSkill(t, home, ".patty/skills/withscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeScript(t, home, ".patty/skills/withscripts/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')")
	writeScript(t, home, ".patty/skills/withscripts/scripts/deploy.sh", "#!/usr/bin/env bash\necho ok")
...
func TestNoScriptsWhenDirAbsent(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/noscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	st := New(Options{HomeDir: home, DisableBuiltins: true})
...
func TestScriptsFilteredByExt(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/scriptscheck/SKILL.md", "---\ndescription: t\n---\nbody")
	writeScript(t, home, ".patty/skills/scriptscheck/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')\n")
	writeScript(t, home, ".patty/skills/scriptscheck/scripts/.hidden.py", "")
	writeScript(t, home, ".patty/skills/scriptscheck/scripts/readme.md", "# readme")
	writeScript(t, home, ".patty/skills/scriptscheck/scripts/deploy", "#!/bin/sh\necho ok")
	writeScript(t, home, ".patty/skills/scriptscheck/scripts/legacy.p", "print 'ok'\n")
	writeScript(t, home, ".patty/skills/scriptscheck/scripts/.gitkeep", "")
...
func TestBuiltinsPresentAndOverridable(t *testing.T) {
	...
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/explore.md", "---\ndescription: mine\nrunAs: inline\n---\nbody")
...
func TestDisabledSkillsAreFilteredFromListAndRead(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/active.md", "---\ndescription: active\n---\nbody")
	writeSkill(t, home, ".patty/skills/hidden.md", "---\ndescription: hidden\n---\nbody")
...
func TestInvalidNamesSkipped(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/bad name.md", "---\ndescription: x\n---\nb") // space → invalid
	st := New(Options{HomeDir: home, DisableBuiltins: true})
	if len(st.List()) != 0 {
...
func TestSymlinkedDirAndFile(t *testing.T) {
	...
	skillsRoot := filepath.Join(home, ".patty", "skills")
...
func TestColorFrontmatterParses(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/tagged.md", "---\ndescription: has a color\ncolor: amber\n---\nbody")
...
func TestManualInvocationSkillExcludedFromIndex(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".patty/skills/private-agent.md", "---\ndescription: my private subagent\nrunAs: subagent\ninvocation: manual\n---\nbody")
	writeSkill(t, home, ".patty/skills/public-agent.md", "---\ndescription: a discoverable subagent\nrunAs: subagent\n---\nbody")
...
func TestCreateRefusesOverwrite(t *testing.T) {
	...
	if !strings.HasSuffix(path, filepath.Join(".patty", "skills", "mine", SkillFile)) {
	...
	writeSkill(t, home, ".patty/skills/legacy.md", "---\ndescription: legacy\n---\nbody")
