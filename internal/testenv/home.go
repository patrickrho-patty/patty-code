...
// IsolateUserState redirects default user-scoped Patty Code paths to a disposable
...
func IsolateUserState() (func(), error) {
	...
	home, err := os.MkdirTemp(originalHome, ".patty-test-home-*")
	if err != nil && originalHome != "" {
		home, err = os.MkdirTemp("", "patty-test-home-*")
	}
	if err != nil {
