// Package netclient builds HTTP clients and proxy resolvers that share Patty Code's
...
// NewHTTPClient returns an HTTP client with patty proxy settings applied.
