...
var English = Messages{
	...
	CmdCompliance:       "Korean compliance audit router (PIPA/KISA/CSAP)",
	CmdPipa:             "PIPA audit (Personal Information Protection Act)",
	CmdKisa:             "KISA secure coding audit (7 categories / 47 items)",
	CmdCsap:             "CSAP audit (Cloud Security Assurance Program)",
