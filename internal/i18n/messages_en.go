...
var English = Messages{
	...
	CompliancePickerTitle:       "compliance frameworks",
	ComplianceItemAll:           "Full Compliance Audit (종합 진단)",
	ComplianceItemAllDesc:       "Full regulatory audit covering PIPA + KISA Secure Coding + CSAP Cloud Security",
	ComplianceItemPipa:          "PIPA (Personal Information Protection Act / 개인정보보호법)",
	ComplianceItemPipaDesc:      "Audit PII collection/logging, AES-256/ARIA/SEED encryption, 1-yr logs, retention/destruction",
	ComplianceItemKisa:          "KISA Secure Coding (시큐어코딩 7대 범주 47개 보안약점)",
	ComplianceItemKisaDesc:      "Audit SQLi/XSS/Path Traversal, authorization, password hashes, PRNG, and error handling",
	ComplianceItemCsap:          "CSAP (Cloud Security Assurance Program / 클라우드 보안인증)",
	ComplianceItemCsapDesc:      "Audit Korea data residency (ap-northeast-2), tenant isolation, MFA, and 365-day audit logging",
	ComplianceRunningFmt:        "Running compliance audit subagent (%s)...",
	...
	CmdCompliance:       "Korean compliance audit framework (PIPA/KISA/CSAP)",
