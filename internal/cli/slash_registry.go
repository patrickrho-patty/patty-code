...
func builtinSlashSpecs() []builtinSlashSpec {
	specs := []builtinSlashSpec{
		...
		{name: "/compliance", ko: "/컴플라이언스", insert: "/compliance ", hint: i18n.M.CmdCompliance, showInHelp: true},
		{name: "/pipa", ko: "/개인정보보호법", insert: "/pipa ", hint: i18n.M.CmdPipa, showInHelp: true},
		{name: "/kisa", ko: "/시큐어코딩", insert: "/kisa ", hint: i18n.M.CmdKisa, showInHelp: true},
		{name: "/csap", ko: "/클라우드보안인증", insert: "/csap ", hint: i18n.M.CmdCsap, showInHelp: true},
