...
const STORAGE_KEY = "patty.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["patty.sidebar.width"],
  sidebarWidthGraphite: [],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["patty.workspaceTree.width"],
  composerHeight: ["patty.composerHeight"],
  drawerWidth: ["patty.drawer.width"],
  settingsDrawerWidth: ["patty.settingsDrawer.width"],
};
