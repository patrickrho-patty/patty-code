...
const mockQwenModelOverrides = [
  { model: "qwen3-max-2026-01-23", reasoningProtocol: "", supportedEfforts: [], defaultEffort: "", contextWindow: 262144 },
  { model: "qwen3-coder-next", reasoningProtocol: "", supportedEfforts: [], defaultEffort: "", contextWindow: 262144 },
  { model: "MiniMax-M2.5", reasoningProtocol: "", supportedEfforts: [], defaultEffort: "", contextWindow: 196608 },
  { model: "glm-5", reasoningProtocol: "", supportedEfforts: [], defaultEffort: "", contextWindow: 202752 },
  { model: "glm-4.7", reasoningProtocol: "", supportedEfforts: [], defaultEffort: "", contextWindow: 202752 },
  { model: "kimi-k2.5", reasoningProtocol: "", supportedEfforts: [], defaultEffort: "", contextWindow: 262144 },
];
...
function makeMockApp(): AppBindings {
    ...
    return out;
      ...
      case "topic_product":
        return [
          ...
          {
            role: "assistant",
            content: "This is a Global-scope session. I can handle questions, planning, and note organization that do not depend on project files; when project access is needed, the desktop app binds or migrates to a project topic explicitly.",
          },
        ];
      case "topic_ai":
        return [
          {
            role: "user",
            content: "Help me organize today's tasks",
          },
          {
            role: "assistant",
  ...
  return {
    ...
    async SetReasoningLanguage(lang: string) {
      const normalized = lang === "ko-KR" || lang === "en" ? lang : "auto";
