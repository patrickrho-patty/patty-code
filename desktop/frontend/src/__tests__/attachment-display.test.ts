...
const named = parseAttachmentRefsForDisplay(
  "review @[DS30000.sl2](.patty/attachments/clipboard-20260610-121238.444775-000002.sl2) and @[park.png](.patty/attachments/clipboard-20260610-121238.444775-000001.png)",
);
...
eq(
  ...
  [
    {
      path: ".patty/attachments/clipboard-20260610-121238.444775-000002.sl2",
      name: "DS30000.sl2",
      kind: "file",
      ext: "SL2",
    },
    {
      path: ".patty/attachments/clipboard-20260610-121238.444775-000001.png",
      name: "park.png",
      kind: "image",
      ext: "PNG",
    },
...
eq(
  replaceAttachmentRefsForDisplay("see @[DS30000.sl2](.patty/attachments/clipboard-20260610-121238.444775-000002.sl2)"),
  "see [file:DS30000.sl2]",
  "compact previews use named display refs",
);
eq(
  restoreAttachmentRefsForSubmit("review @[DS30000.sl2](.patty/attachments/clipboard-20260610-121238.444775-000002.sl2), then @[park.png](.patty/attachments/clipboard-20260610-121238.444775-000001.png)"),
  "review @.patty/attachments/clipboard-20260610-121238.444775-000002.sl2, then @.patty/attachments/clipboard-20260610-121238.444775-000001.png",
  "restores named display refs for submit",
);
eq(
  formatAttachmentRefForDisplay({ path: ".patty/attachments/clipboard-20260610-121238.444775-000001.png", name: "park.png", source: "attachment" }),
  "@[park.png](.patty/attachments/clipboard-20260610-121238.444775-000001.png)",
  "formats attachment display refs for edit replay",
);
eq(
  formatAttachmentRefForSubmit({ path: ".patty/attachments/clipboard-20260610-121238.444775-000001.png" }),
  "@.patty/attachments/clipboard-20260610-121238.444775-000001.png",
