...
def main():
    ...
    zh.append("八款 Patty Code 官方主题的全部图片均为**原创**，由 `scripts/official-theme-art/` 中的脚本")
    ...
    zh.append("素材随 Patty Code 仓库以 MIT 许可发布，© Patty Code Contributors。人工审核：Patty Code Contributors（发布 PR 审核）。\n")
