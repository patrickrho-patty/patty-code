// Command patty-launcher is the permanent thin desktop entry point for the
// versioned install layout (v1.20+). It reads InstallRoot/current.json, starts
// the active patty-desktop binary, and exits. It never counts crashes,
...
import (
	...
	"patty/internal/desktoplauncher"
)
