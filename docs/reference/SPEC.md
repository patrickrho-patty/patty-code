...
README is bilingual (`README.md` Korean default + `README.en.md` English secondary).
...
├── docs/reference/SPEC.md   # this file
...
[Configuration paths](../guides/CONFIG_PATHS.md) for migration and related data paths.
